...
class ContainerViewController: UIViewController, EmbeddedViewControllerDelegate, UIGestureRecognizerDelegate {
    ...
    fileprivate let swipeAnimateDuration = 0.6
    ...
    fileprivate func showContainer(_ position: Position) {
        ...
        UIView.animate(withDuration: swipeAnimateDuration, delay: 0, usingSpringWithDamping: 1, initialSpringVelocity: 1, options: [.curveEaseInOut, .allowUserInteraction], animations: {
